...
[![Version](https://img.shields.io/badge/Version-ver%200.13-blue.svg)](config/static/base.json)
...
| `config/static/base.json`   | `version`                                                                                                                               | 版本号唯一来源（ver 0.13）             |
...
|                             | `unknown_label`、`cost_zero_epsilon`、`total_tokens_unit`、`total_tokens_unit_threshold`、`status_time_format`                          | 分组缺失标签、费用容差、单位与时间格式 |
