...
[![Version](https://img.shields.io/badge/Version-ver%200.12-blue.svg)](config/static/base.json)
...
├── utils/                     # 通用工具
│   ├── logger.py              # 统一日志（控制台 + 文件，项目内 data/logs/myboard.log）
...
| `config/static/base.json`   | `version`                                                                                                                               | 版本号唯一来源（ver 0.12）           |
